...
%%
%%%%%% Binarize the data %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%% This is the data we use in our ICML paper %%%%%%%%%%%%%%%%%%
...
rand('state',30);
batchdata = batchdata > rand(numcases,numdims,numbatches);

[numcases numdims numbatches]=size(testbatchdata);
rand('state',30);
testbatchdata = testbatchdata > rand(numcases,numdims,numbatches);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
